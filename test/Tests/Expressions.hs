...
testExpressions =
  ...
  [ testGroup "Conversions"
    [ checkParseExpr Succeed "1in | mm" (25.4 %# milli -| meter)
    , checkParseExpr Succeed "1in | m" (0.0254 %# meter)
    , checkParseExpr Succeed "3 km^2 | m^2" (3000000 %# meter #^ 2)
    , checkParseExpr Succeed "7.2 km/h | m/s" (2 %# meter #/ second)
    , checkParseExpr Succeed "3 kbit/min | bit/s" (50 %# bit #/ second)
    , checkParseExpr Succeed "7 nm * 1000000 | mm"   (7 %# milli -| meter)
    ]
  , testGroup "Addition and subtraction"
    ...
    , checkParseExpr Succeed "1km + 1m | m" (1001 %# meter)
  ...
  , testGroup "Multiplication and division"
    ...
    , checkParseExpr Succeed "10m / 2s | km/h" (18 %# kilo -| meter #/ hour)
    ]
  ]
